...
- [x] 007 — Light theme (built, live acceptance pending — no live Electron env in this session)
- [x] 012 — S02 residuals — never hide a live session, never steal the focus (built, live acceptance pending — no live Electron env in this session)
